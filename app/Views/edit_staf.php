                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="<?= base_url('/home/aksi_editstaf') ?>" method="post">
                                <input type="hidden" name="id" value="<?php echo $staf->id_user ?>">
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-email">Nama Staf <span
                                            class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" value="<?= $staf->nama ?>" required
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" value="<?= $staf->alamat ?>" required
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="date" class="form-control" value="<?= $staf->tanggal_lahir ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" value="<?= $staf->tempat_lahir ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="jenis_kelamin" class="form-control" required>
                                            <option value="<?= $staf->jenis_kelamin ?>" selected hidden>---Choose---
                                            </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control" value="<?= $staf->no_tlp ?>" required
